...
// PDF rendering and iterator functions (structs defined via typedef in kreuzberg.h)
...
CPdfPageIterator *kreuzberg_pdf_page_iterator_new(const char *path, int32_t dpi);
